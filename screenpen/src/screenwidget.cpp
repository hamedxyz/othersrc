        ...
        ui(new Ui::screenwidget)
{
   ...
   _drawMode = DRAWMODE_ARROW;
    ...
    _activePen.setColor(QColor("#cc241d"));
...
void ScreenWidget::keyPressEvent(QKeyEvent *event)
{
    ...
    if (key == Qt::Key_Escape ||
        ...
        _activePen.setColor(QColor("#98971a"));
    } else if (key == Qt::Key_B) {
        _activePen.setColor(QColor("#458588"));
    } else if (key == Qt::Key_C) {
        _activePen.setColor(QColor("#689d6a"));
    } else if (key == Qt::Key_M) {
        _activePen.setColor(QColor("#b16286"));
    } else if (key == Qt::Key_Y) {
        _activePen.setColor(QColor("#d79921"));
